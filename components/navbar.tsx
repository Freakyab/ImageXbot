        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div>
            <div className="text-gray-300">
              {user?._id ? (
                <>
                <span className={`text-sm font-semibold ${calculateTokens() > 7000 ? "text-red-500" : "text-green-500"}`}>
          ...
          <div className="flex items-center">
            {!user?._id ? (
              <button
                ...
                className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded-md transition-colors duration-200 flex items-center">
              ...
              <button
                ...
                className="bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded-md transition-colors duration-200 flex items-center">
